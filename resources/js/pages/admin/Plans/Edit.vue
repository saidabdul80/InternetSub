...
import { index, update } from '@/routes/admin/plans';
...
const form = useForm({
    ...
    price_kobo: props.plan.price_kobo,
    speed_mbps: props.plan.speed_mbps,
    duration_minutes: props.plan.duration_minutes,
    mikrotik_profile: props.plan.mikrotik_profile,
        ...
        <div class="flex flex-col gap-6">
            <div>
                ...
                <p class="text-sm text-muted-foreground">
                    Update pricing, speed, and MikroTik profile settings.
                </p>
            </div>
